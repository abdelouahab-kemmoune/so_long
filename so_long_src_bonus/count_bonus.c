...
/*   Updated: 2025/03/03 14:38:39 by akemmoun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_count(t_game *game)
{
	...
	game->count_moves = mlx_xpm_file_to_image(game->mlx, "./assets/count.xpm",
			&game->img_width, &game->img_height);
	x = 20;
	y = ((game->rows * game->img_height) + 52) - 20;
	mlx_put_image_to_window(game->mlx, game->window, game->count_moves, x + 50,
		y - 30);
